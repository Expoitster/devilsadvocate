...
Source of truth for all on-page text. You may tighten wording, but keep the tone and the facts. `{{FORM_ENDPOINT}}` and `{{CONTACT_EMAIL}}` are placeholders to fill before launch.
